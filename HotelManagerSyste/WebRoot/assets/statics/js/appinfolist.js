...
$(".addVersion").on("click",function(){
	var obj = $(this);
	window.location.href="appversionadd.html?id="+obj.attr("appinfoid");
});
...
$(".modifyAppInfo").on("click",function(){
	var obj = $(this);
		...
		window.location.href="update.html?id="+ obj.attr("appinfoid");
...
var dropdownMenu = function(appId,obj){
	$.ajax({
		url:"sale.json",//请求的url
...
$(".viewApp").on("click",function(){
	var obj = $(this);
	window.location.href="appView.html?id="+ obj.attr("appinfoid");
});
