...
<body>
	...
	<div class="head">
		<div class="headL">
			<img class="headLogo" src="${pageContext.request.contextPath }/assets/img/logo.jpg"/>
		</div>
		<div class="headR">
			<span style="color:#FFF">欢迎：${userSession.userID }</span> <a href="${pageContext.request.contextPath }/tuichus.html" target="_blank">【退出】</a></span> 
		</div>
	</div>
</body>
</html>