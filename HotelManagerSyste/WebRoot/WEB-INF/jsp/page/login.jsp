...
<html>
  <head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath }/assets/common/layui/css/layui.css">
	<link rel="stylesheet" href="${pageContext.request.contextPath }/assets/common/css/sccl.css">
    <style type="text/css">
  ...
  <body class="login-bg">
    <div class="login-box">
        ...
        <span style="color: #C60101;font-size: 20px">${error}</span>  
			<form action="${pageContext.request.contextPath }/loginuser.html" class="layui-form" method="post">
				...
				<div class="layui-form-item">
					...
					<input type="text" name="userID" lay-verify="userName" autocomplete="off" placeholder="这里输入登录名" class="layui-input">
				</div>
				<div class="layui-form-item">
					<label class="login-icon">
						<i class="layui-icon"></i>
    ...
    <script src="${pageContext.request.contextPath }/assets/common/layui/layui.js"></script>
    <script>
      ...
      var errorCount = 0;
       ...
       form.on('submit(login)', function (data) {
				/* window.location.href = "WEB-INF/jsp/page/index.jsp"; */
                if (errorCount > 5) {
                    layer.open({
